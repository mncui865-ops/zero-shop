...
<div id="splash" style="position:fixed;top:0;left:0;width:100%;height:100%;background:#000;z-index:99999;display:flex;align-items:center;justify-content:center;transition:opacity 1s;overflow:hidden;">
    ...
    <button onclick="closeSplash()" style="position:absolute;bottom:100px;z-index:2;background:rgba(0,255,136,0.2);border:2px solid #00ff88;color:#00ff88;padding:12px 35px;border-radius:30px;font-size:16px;font-weight:700;cursor:pointer;transition:0.3s;backdrop-filter:blur(10px);">تجاوز ▶</button>
</div>
<script>
...
@app.route('/')
def home():
    # إعادة تعيين splash_shown عند الدخول للصفحة الرئيسية
